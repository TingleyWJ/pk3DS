...
public partial class RSTE : Form
{
    ...
    public RSTE(byte[][] trd, byte[][] trp)
    {
		...
		trpk_nature = [TB_Pokemon_1_Nature, TB_Pokemon_2_Nature, TB_Pokemon_3_Nature, TB_Pokemon_4_Nature, TB_Pokemon_5_Nature, TB_Pokemon_6_Nature];
		#endregion
    ...
    private void ReadFile()
    {
		...
		ReloadNatureMap(TC_TabControl, EventArgs.Empty);
	}
    ...
    private void GotoParty(object sender, EventArgs e)
    {
        ...
        TC_TabControl.SelectedIndex = 1 + Array.IndexOf([PB_Team1, PB_Team2, PB_Team3, PB_Team4, PB_Team5, PB_Team6], sender as PictureBox);
    }
	...
	private void B_Export_Calc(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < AXHelpers.AXTrainerIndexes.Length; i++)
		{
			...
			string trShortenedName = CB_TrainerID.Text[..^6];
			...
			for (int j = 0; j < AXHelpers.AXTagTrainerIndexes.Length; j++)
			{
				...
				if (CB_TrainerID.SelectedIndex == tagIndices.Item1)
				{
					...
					trainerName2 = CB_TrainerID.Text[..^6];
				...
				else if (CB_TrainerID.SelectedIndex == tagIndices.Item2)
				{
					...
					trainerName1 = CB_TrainerID.Text[..^6];
					CB_TrainerID.SelectedIndex = originalIndex;
				}
	...
	{
		bool parsed = int.TryParse(TC_TabControl.SelectedTab.Name[^1..], out int tabIndex);
		if (!parsed)
		{

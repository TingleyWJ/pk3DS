...
public class ExportPokemonSite()
{
    ...
    public List<ExportPokemonTM> TMs { get; set; } = [];
}
...
public class ExportTrSite()
{
	...
	public List<ExportTrPkmSite> Pokemon { get; set; } = [];
}
...
public class ExportRouteSite()
{
	...
	public string Notes { get; set; }
	public List<ExportTrSite> Trainers { get; set; } = [];
}
...
public class ExportEvoSite()
{
    ...
    public Dictionary<string, string> EvolvesInto { get; set; } = [];
}

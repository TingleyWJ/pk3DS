...
namespace pk3DS.Core.Structures.AXExports
{
	public static class AXHelpers
	{
		...
		public static readonly Tuple<int, int, int>[] AXTagTrainerIndexes = new Tuple<int, int, int>[]
		{
		...
		public static readonly Tuple<int, string>[] TrainerIDRenames = new Tuple<int, string>[]
		{
		...
		public static readonly int[] TrainerIDSkips = new int[]
		{
			462,	// Sherlock
			463,	// Finnian
			465,	// Nelly
	...
	public class AXExtraTrainerInfo
	{
		...
		public AXExtraTrainerInfo(string route, string required, bool resetEncounterIndex = false, string notes = "", bool tagBattle = false)
		{
			Route = route;
			EncounterIndex = resetEncounterIndex ? trIDIncr = 0 : ++trIDIncr;
			Required = required;
			Notes = notes;
			IsTagBattle = tagBattle;
		}
	...
	public class AXExtraRouteInfo
	{
		...
		public AXExtraRouteInfo(bool required, string notes = "")
		{
			RouteIndex = routeIncr++;
			Required = required;
			Notes = notes;
		}
